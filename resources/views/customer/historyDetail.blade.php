                    ...
                    <table class="table table-striped mt-2">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                @elseif($transaksi_detail->transaksi->bukti_transfer == "")
                                <td>Upload Bukti Transfer Terlebih Dahulu</td>
                                @elseif($transaksi_detail->transaksi->status == 1)
                            ...
                            <tr>
                                ...
                                <td ><strong>Rp. {{ number_format(($transaksi->ongkir)) }}</strong></td>
                            </tr>
                            <tr>
                                <td></td><td></td><td></td><td></td><td></td>
                                <td ><strong>Total Bayar :</strong></td>
                                <td ><strong>Rp. {{ number_format($transaksi->jumlah_harga + $transaksi->kode + ($transaksi->ongkir)) }}</strong></td>
                            </tr>
                            <tr>
